  ...
  return (
    <Experience
      ...
      component={(props: ISetting) => {
        ...
        return (
          <div className=" lg:pb-12 hero min-h-[75vh] relative"
          >
            {
              updatedHero.fields.halfWidth !== true && updatedHero.fields.image.fields?.file.details.image && (
                  <Image
                    ...
                    height={0}
                    sizes="100vw"
                    style={{ position: "absolute", width: '100%', height: '100%', objectFit: "cover", }} // optional
            ...
            <div className="pt-8 sm:pt-12 lg:relative lg:py-6">
              ...
              >
                ...
                {/* Image */}
                {updatedHero.fields.halfWidth == true && (
                  <div
                    className={classNames(
